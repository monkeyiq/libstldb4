 ...
 *
 * $Id: stldbraw.h,v 1.2 2007/10/24 21:30:56 ben Exp $
 *
 ...
 */
#define	dbm_clearerr(a)		__db_ndbm_clearerrstldb4(a)
#define	dbm_close(a)		__db_ndbm_closestldb4(a)
#define	dbm_delete(a, b)	__db_ndbm_deletestldb4(a, b)
#define	dbm_dirfno(a)		__db_ndbm_dirfnostldb4(a)
#define	dbm_error(a)		__db_ndbm_errorstldb4(a)
#define	dbm_fetch(a, b)		__db_ndbm_fetchstldb4(a, b)
#define	dbm_firstkey(a)		__db_ndbm_firstkeystldb4(a)
#define	dbm_nextkey(a)		__db_ndbm_nextkeystldb4(a)
#define	dbm_open(a, b, c)	__db_ndbm_openstldb4(a, b, c)
#define	dbm_pagfno(a)		__db_ndbm_pagfnostldb4(a)
#define	dbm_rdonly(a)		__db_ndbm_rdonlystldb4(a)
#define	dbm_store(a, b, c, d) \
	__db_ndbm_storestldb4(a, b, c, d)
 ...
 */
#define	dbminit(a)	__db_dbm_initstldb4(a)
#define	dbmclose	__db_dbm_closestldb4
#if !defined(__cplusplus)
#define	delete(a)	__db_dbm_deletestldb4(a)
#endif
#define	fetch(a)	__db_dbm_fetchstldb4(a)
#define	firstkey	__db_dbm_firstkeystldb4
#define	nextkey(a)	__db_dbm_nextkeystldb4(a)
#define	store(a, b)	__db_dbm_storestldb4(a, b)
...
#define	hcreate(a)	__db_hcreatestldb4(a)
#define	hdestroy	__db_hdestroystldb4
#define	hsearch(a, b)	__db_hsearchstldb4(a, b)
...
#define	db_create db_createstldb4
#define	db_strerror db_strerrorstldb4
#define	db_env_create db_env_createstldb4
#define	db_version db_versionstldb4
#define	log_compare log_comparestldb4
#define	db_env_set_func_close db_env_set_func_closestldb4
#define	db_env_set_func_dirfree db_env_set_func_dirfreestldb4
#define	db_env_set_func_dirlist db_env_set_func_dirliststldb4
#define	db_env_set_func_exists db_env_set_func_existsstldb4
#define	db_env_set_func_free db_env_set_func_freestldb4
#define	db_env_set_func_fsync db_env_set_func_fsyncstldb4
#define	db_env_set_func_ftruncate db_env_set_func_ftruncatestldb4
#define	db_env_set_func_ioinfo db_env_set_func_ioinfostldb4
#define	db_env_set_func_malloc db_env_set_func_mallocstldb4
#define	db_env_set_func_map db_env_set_func_mapstldb4
#define	db_env_set_func_pread db_env_set_func_preadstldb4
#define	db_env_set_func_pwrite db_env_set_func_pwritestldb4
#define	db_env_set_func_open db_env_set_func_openstldb4
#define	db_env_set_func_read db_env_set_func_readstldb4
#define	db_env_set_func_realloc db_env_set_func_reallocstldb4
#define	db_env_set_func_rename db_env_set_func_renamestldb4
#define	db_env_set_func_seek db_env_set_func_seekstldb4
#define	db_env_set_func_sleep db_env_set_func_sleepstldb4
#define	db_env_set_func_unlink db_env_set_func_unlinkstldb4
#define	db_env_set_func_unmap db_env_set_func_unmapstldb4
#define	db_env_set_func_write db_env_set_func_writestldb4
#define	db_env_set_func_yield db_env_set_func_yieldstldb4
#define	db_sequence_create db_sequence_createstldb4
#if DB_DBM_HSEARCH != 0
#define	__db_ndbm_clearerr __db_ndbm_clearerrstldb4
#define	__db_ndbm_close __db_ndbm_closestldb4
#define	__db_ndbm_delete __db_ndbm_deletestldb4
#define	__db_ndbm_dirfno __db_ndbm_dirfnostldb4
#define	__db_ndbm_error __db_ndbm_errorstldb4
#define	__db_ndbm_fetch __db_ndbm_fetchstldb4
#define	__db_ndbm_firstkey __db_ndbm_firstkeystldb4
#define	__db_ndbm_nextkey __db_ndbm_nextkeystldb4
#define	__db_ndbm_open __db_ndbm_openstldb4
#define	__db_ndbm_pagfno __db_ndbm_pagfnostldb4
#define	__db_ndbm_rdonly __db_ndbm_rdonlystldb4
#define	__db_ndbm_store __db_ndbm_storestldb4
#define	__db_dbm_close __db_dbm_closestldb4
#define	__db_dbm_delete __db_dbm_deletestldb4
#define	__db_dbm_fetch __db_dbm_fetchstldb4
#define	__db_dbm_firstkey __db_dbm_firstkeystldb4
#define	__db_dbm_init __db_dbm_initstldb4
#define	__db_dbm_nextkey __db_dbm_nextkeystldb4
#define	__db_dbm_store __db_dbm_storestldb4
#endif
#if DB_DBM_HSEARCH != 0
#define	__db_hcreate __db_hcreatestldb4
#define	__db_hsearch __db_hsearchstldb4
#define	__db_hdestroy __db_hdestroystldb4
#endif
#define	db_xa_switch db_xa_switchstldb4
