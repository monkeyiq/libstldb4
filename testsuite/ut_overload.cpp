...
*******************************************************************************
    ...
    $Id: ut_overload.cpp,v 1.2 2010/09/24 05:15:38 ben Exp $
...
const string PROGRAM_NAME = "ut_overload";
...
void runtest()
{
    ...
    cerr << "neo is at:" << db[ "neo" ] << endl;

    const std::string& alicehome = db[ "alice" ];
    cerr << "alice is at:" << alicehome << endl;
