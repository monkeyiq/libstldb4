...
*******************************************************************************
    ...
    $Id: ut_partial_lookup.cpp,v 1.2 2010/09/24 05:15:38 ben Exp $
...
const string PROGRAM_NAME = "ut_partial_lookup";
...
void runtest( string KEY = "al" )
{
    ...
    Database::iterator iter = db->find_partial( KEY );
    
    cerr << "partial lookup for key=\"" << KEY << "\""
         << " gives whole key=\"" << iter->first << "\""
         << " and gives data=\"" << iter->second << "\"" << endl;
